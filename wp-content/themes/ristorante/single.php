...
<div class="nicdark_section nicdark_border_bottom_1_solid_grey">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="nicdark_grid_12">
            ...
            <h1 class="nicdark_font_size_50 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone nicdark_hyphens_auto nicdark_word_break_break_all"><?php the_title(); ?></h1>
        ...
        while(have_posts()) : the_post(); ?>
            ...
            <div class="nicdark_section">
                ...
                <?php $args = array(
                    ...
                    'nextpagelink'     => esc_html__('Next page', 'ristorante'),
                    'previouspagelink' => esc_html__('Previous page', 'ristorante'),
                    'pagelink'         => '%',
                    'echo'             => 1
                ); ?>
                ...
                <?php if(has_tag()) { ?>  
                    ...
                    <div id="nicdark_tags_list" class="nicdark_section">
                        <?php esc_html_e('Tags : ','ristorante'); ?>
                        <br/>
                        <?php the_tags('','',''); ?>
                    </div>
                    <!--END tag-->
                ...
                <?php 
                    esc_html_e('Categories : ','ristorante');
                    the_category();
                ?>
                </div>
                <!--END categories-->
