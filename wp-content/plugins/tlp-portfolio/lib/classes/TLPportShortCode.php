					...
					if ( $portfolioQuery->have_posts() ) {
						...
						if ( $isIsotope ) {
							...
							if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) {
                                ...
                                $html .= '<select class="select-filter" style="display: none">';
                                $html .= '<option data-filter="*">'.__( "Show all", "tlp-portfolio" ).'</option>';
                                foreach ( $terms as $term ) {
                                    if ( ! empty( $cat_ids ) ) {
                                        if ( in_array( $term->term_id, $cat_ids ) ) {
                                            $html .= "<option data-filter='.{$term->slug}'>" . $term->name . "</option>";
                                        }
                                    } else {
                                        $html .= "<option data-filter='.{$term->slug}'>" . $term->name . "</option>";
                                    }
