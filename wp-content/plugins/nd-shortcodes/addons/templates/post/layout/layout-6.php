...
if ( $nd_options_meta_box_post_header_img != '' ) { ?>  
    ...
    <?php if(have_posts()) :
        while(have_posts()) : the_post(); ?>
            ...
            <div id="nd_options_post_header_img_layout_6" class="nd_options_section nd_options_background_size_cover <?php echo $nd_options_meta_box_post_header_img_position ?>" style="background-image:url(<?php echo $nd_options_meta_box_post_header_img; ?>);">
                    ...
                    <div class="nd_options_container nd_options_clearfix">
                        ...
                        <div class="nd_options_section nd_options_padding_15 nd_options_box_sizing_border_box nd_options_text_align_center">
                            ...
                            <h1 class="nd_options_color_white nd_options_font_weight_normal nd_options_first_font">
                                <span class="nd_options_display_block"><?php echo $nd_options_meta_box_post_header_img_title; ?></span>
                                ...
                                <div class="nd_options_display_inline_block">
                                    ...
                                    <div class="nd_options_section nd_options_position_relative nd_options_padding_right_40  nd_options_box_sizing_border_box">
                                        ...
                                        <div class="nd_options_section nd_options_padding_left_45 nd_options_box_sizing_border_box">
                                            ...
                                            <h3 class="nd_options_color_white nd_options_font_size_14 nd_options_letter_spacing_1 nd_options_text_transform_uppercase nd_options_second_font"><?php echo get_the_author(); ?></h3>
                                        </div>
                                    </div>
                                    <div class="nd_options_section nd_options_height_10"></div>
