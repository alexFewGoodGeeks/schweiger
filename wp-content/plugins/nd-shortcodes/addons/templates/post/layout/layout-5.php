...
if ( $nd_options_meta_box_post_header_img != '' ) { ?>  
    ...
    <?php if(have_posts()) :
        while(have_posts()) : the_post(); ?>
            ...
            <div id="nd_options_post_header_img_layout_5" class="nd_options_section nd_options_background_size_cover <?php echo $nd_options_meta_box_post_header_img_position ?>" style="background-image:url(<?php echo $nd_options_meta_box_post_header_img; ?>);">
