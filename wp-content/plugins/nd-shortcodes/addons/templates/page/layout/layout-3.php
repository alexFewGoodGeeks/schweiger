...
if ( $nd_options_meta_box_page_header_img != '' ) { ?>	
	...
	<div id="nd_options_page_header_img_layout_3" class="nd_options_section nd_options_background_size_cover <?php echo $nd_options_meta_box_page_header_img_position ?>" style="background-image:url(<?php echo $nd_options_meta_box_page_header_img; ?>);">
        ...
        <div class="nd_options_section nd_options_bg_greydark_alpha_2">
            ...
            <div class="nd_options_container nd_options_clearfix nd_options_text_align_center">
                ...
                <div class="nd_options_section nd_options_padding_15 nd_options_box_sizing_border_box">
                    ...
                    <h1 class="nd_options_color_white nd_options_font_size_50 nd_options_font_size_40_all_iphone nd_options_line_height_40_all_iphone nd_options_first_font"><strong><?php echo $nd_options_meta_box_page_header_img_title; ?></strong></h1>
