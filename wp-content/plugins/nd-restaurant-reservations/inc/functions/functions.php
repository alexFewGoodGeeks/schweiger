...
function nd_rst_get_qnt_guests_on_local($nd_rst_time_slot,$nd_rst_date,$nd_rst_restaurant){
  ...
  $nd_rst_reservations = $wpdb->get_results( "SELECT * FROM $nd_rst_table_name WHERE nd_rst_date = '$nd_rst_date' AND nd_rst_restaurant = '$nd_rst_restaurant' AND '$nd_rst_time_slot_normal_format' >= nd_rst_time_start AND '$nd_rst_time_slot_normal_format' <= nd_rst_time_end AND nd_rst_order_status = 'confirmed'");
...
function nd_rst_get_availability($nd_rst_date,$nd_rst_time_slot,$nd_rst_guests,$nd_rst_restaurant_id){
  ...
  $nd_rst_reservations = $wpdb->get_results( "SELECT * FROM $nd_rst_table_name WHERE nd_rst_date = '$nd_rst_date_normal_format' AND nd_rst_restaurant = '$nd_rst_restaurant_id' AND nd_rst_order_status = 'confirmed'");
...
function nd_rst_check_if_order_is_present($nd_rst_tx){
  ...
  //START query
  $nd_rst_order_ids = $wpdb->get_results( "SELECT id FROM $nd_rst_table_name WHERE nd_rst_tx = '$nd_rst_tx'" );
