      ...
      <!--START menu-->
        <div style="background-color:<?php echo nd_rst_get_profile_bg_color(1); ?>;" class="nd_rst_width_20_percentage nd_rst_float_left nd_rst_box_sizing_border_box nd_rst_min_height_3000 nd_rst_position_absolute">
          ...
          <ul class="nd_rst_navigation">
            ...
            <li><a style="background-color:<?php echo nd_rst_get_profile_bg_color(2); ?>;"class="" href="#"><?php _e('Import Export','nd-restaurant-reservations'); ?></a></li>
        ...
        <div class="nd_rst_section">
          ...
          <div class="nd_rst_width_60_percentage nd_rst_padding_20 nd_rst_box_sizing_border_box nd_rst_float_left">
            ...
            <div class="nd_rst_section nd_rst_padding_left_20 nd_rst_padding_right_20 nd_rst_box_sizing_border_box">
                ...
                <a class="button button-primary" href="data:application/octet-stream;charset=utf-8,<?php echo $nd_rst_name_write_new; ?>" download="nd-restaurant-reservations-export.txt"><?php _e('Export','nd-restaurant-reservations'); ?></a>
...
function nd_rst_import_settings_php_function() {
  ...
  echo $nd_rst_import_settings_result;
