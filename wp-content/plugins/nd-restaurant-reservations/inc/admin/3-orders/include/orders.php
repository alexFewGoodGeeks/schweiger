...
if ( $nd_rst_order_status == '' ) { 
  $nd_rst_orders = $wpdb->get_results( "SELECT * FROM $nd_rst_table_name ORDER BY id DESC LIMIT $nd_rst_pag_from, $nd_rst_pag_to");  
}else{
  $nd_rst_orders = $wpdb->get_results( "SELECT * FROM $nd_rst_table_name WHERE nd_rst_order_status = '$nd_rst_order_status' ORDER BY id DESC LIMIT $nd_rst_pag_from, $nd_rst_pag_to");
}

$nd_rst_all_orders = $wpdb->get_results( "SELECT * FROM $nd_rst_table_name");

$nd_rst_all_orders_pending = $wpdb->get_results( "SELECT * FROM $nd_rst_table_name WHERE nd_rst_order_status = 'pending'");
$nd_rst_all_orders_confirmed = $wpdb->get_results( "SELECT * FROM $nd_rst_table_name WHERE nd_rst_order_status = 'confirmed'");
