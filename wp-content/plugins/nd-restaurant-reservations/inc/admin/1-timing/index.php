    ...
    <div class="nd_rst_section  nd_rst_box_shadow_0_1_1_000_04 nd_rst_background_color_ffffff nd_rst_border_1_solid_e5e5e5 nd_rst_border_top_width_0 nd_rst_border_left_width_0 nd_rst_overflow_hidden nd_rst_position_relative">
      ...
      <div style="background-color:<?php echo nd_rst_get_profile_bg_color(1); ?>;" class="nd_rst_width_20_percentage nd_rst_float_left nd_rst_box_sizing_border_box nd_rst_min_height_3000 nd_rst_position_absolute">
        ...
        <ul class="nd_rst_navigation">
          ...
          <li><a style="background-color:<?php echo nd_rst_get_profile_bg_color(2); ?>;"class="" href="#"><?php _e('Timing','nd-restaurant-reservations'); ?></a></li>
          <li><a class="" href="<?php echo admin_url('admin.php?page=nd-restaurant-reservations-add-exception'); ?>"><?php _e('Exceptions','nd-restaurant-reservations'); ?></a></li>
        ...
        <div id="nd_rst_all_timing" class="nd_rst_section">
          ...
          <div id="nd_rst_timing_<?php echo $nd_rst_i; ?>" class="nd_rst_section ">
            ...
            <div class="nd_rst_width_60_percentage nd_rst_padding_20 nd_rst_box_sizing_border_box nd_rst_float_left">
              ...
              <div class="nd_rst_section">
                ...
                <div class="nd_rst_width_12_percentage nd_rst_box_sizing_border_box nd_rst_float_left nd_rst_text_align_center">
                  <input class="nd_rst_margin_0_important" <?php if( get_option('nd_rst_timing_1_'.$nd_rst_i) == 1 ) { echo 'checked="checked"'; } ?> name="nd_rst_timing_1_<?php echo $nd_rst_i; ?>" type="checkbox" value="1">
                  <p class="nd_rst_color_666666 nd_rst_section nd_rst_margin_0 nd_rst_margin_top_20"><?php _e('Mon','nd-restaurant-reservations'); ?></p>
                </div> 
                <div class="nd_rst_width_12_percentage nd_rst_box_sizing_border_box nd_rst_float_left nd_rst_text_align_center">
                  <input class="nd_rst_margin_0_important" <?php if( get_option('nd_rst_timing_2_'.$nd_rst_i) == 1 ) { echo 'checked="checked"'; } ?> name="nd_rst_timing_2_<?php echo $nd_rst_i; ?>" type="checkbox" value="1">
                  <p class="nd_rst_color_666666 nd_rst_section nd_rst_margin_0 nd_rst_margin_top_20"><?php _e('Tue','nd-restaurant-reservations'); ?></p>
                </div> 
                <div class="nd_rst_width_12_percentage nd_rst_box_sizing_border_box nd_rst_float_left nd_rst_text_align_center">
                  <input class="nd_rst_margin_0_important" <?php if( get_option('nd_rst_timing_3_'.$nd_rst_i) == 1 ) { echo 'checked="checked"'; } ?> name="nd_rst_timing_3_<?php echo $nd_rst_i; ?>" type="checkbox" value="1">
                  <p class="nd_rst_color_666666 nd_rst_section nd_rst_margin_0 nd_rst_margin_top_20"><?php _e('Wed','nd-restaurant-reservations'); ?></p>
                </div> 
                <div class="nd_rst_width_12_percentage nd_rst_box_sizing_border_box nd_rst_float_left nd_rst_text_align_center">
                  <input class="nd_rst_margin_0_important" <?php if( get_option('nd_rst_timing_4_'.$nd_rst_i) == 1 ) { echo 'checked="checked"'; } ?> name="nd_rst_timing_4_<?php echo $nd_rst_i; ?>" type="checkbox" value="1">
                  <p class="nd_rst_color_666666 nd_rst_section nd_rst_margin_0 nd_rst_margin_top_20"><?php _e('Thu','nd-restaurant-reservations'); ?></p>
                </div> 
                <div class="nd_rst_width_12_percentage nd_rst_box_sizing_border_box nd_rst_float_left nd_rst_text_align_center">
                  <input class="nd_rst_margin_0_important" <?php if( get_option('nd_rst_timing_5_'.$nd_rst_i) == 1 ) { echo 'checked="checked"'; } ?> name="nd_rst_timing_5_<?php echo $nd_rst_i; ?>" type="checkbox" value="1">
                  <p class="nd_rst_color_666666 nd_rst_section nd_rst_margin_0 nd_rst_margin_top_20"><?php _e('Fri','nd-restaurant-reservations'); ?></p>
                </div> 
                <div class="nd_rst_width_12_percentage nd_rst_box_sizing_border_box nd_rst_float_left nd_rst_text_align_center">
                  <input class="nd_rst_margin_0_important" <?php if( get_option('nd_rst_timing_6_'.$nd_rst_i) == 1 ) { echo 'checked="checked"'; } ?> name="nd_rst_timing_6_<?php echo $nd_rst_i; ?>" type="checkbox" value="1">
                  <p class="nd_rst_color_666666 nd_rst_section nd_rst_margin_0 nd_rst_margin_top_20"><?php _e('Sat','nd-restaurant-reservations'); ?></p>
                </div> 
                <div class="nd_rst_width_12_percentage nd_rst_box_sizing_border_box nd_rst_float_left nd_rst_text_align_center">
                  <input class="nd_rst_margin_0_important" <?php if( get_option('nd_rst_timing_7_'.$nd_rst_i) == 1 ) { echo 'checked="checked"'; } ?> name="nd_rst_timing_7_<?php echo $nd_rst_i; ?>" type="checkbox" value="1">
            ...
            <div class="nd_rst_width_20_percentage nd_rst_padding_20 nd_rst_box_sizing_border_box nd_rst_float_left">
              ...
              <select class="nd_rst_width_100_percentage" name="nd_rst_timing_start_<?php echo $nd_rst_i; ?>">
                ...
                <?php foreach ($nd_rst_timing_sols as $nd_rst_timing_sol) : ?>
                    ...
                    value="<?php echo $nd_rst_timing_sol; ?>">
                        <?php echo $nd_rst_timing_sol; ?>
                    </option>
                <?php endforeach; ?>
              </select>
            ...
            <div class="nd_rst_width_20_percentage nd_rst_padding_20 nd_rst_box_sizing_border_box nd_rst_float_left">
              ...
              <select class="nd_rst_width_100_percentage" name="nd_rst_timing_end_<?php echo $nd_rst_i; ?>">
                <?php $nd_rst_timing_sols = array('00:00','00:30','01:00','01:30','02:00','02:30','03:00','03:30','04:00','04:30','05:00','05:30','06:00','06:30','07:00','07:30','08:00','08:30','09:00','09:30','10:00','10:30','11:00','11:30','12:00','12:30','13:00','13:30','14:00','14:30','15:00','15:30','16:00','16:30','17:00','17:30','18:00','18:30','19:00','19:30','20:00','20:30','21:00','21:30','22:00','22:30','23:00','23:30'); ?>
                <?php foreach ($nd_rst_timing_sols as $nd_rst_timing_sol) : ?>
                    <option 
