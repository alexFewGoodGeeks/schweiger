...
function nd_rst_shortcode_reservation_form($nd_rst_atts) {
    ...
    if ( isset($_GET['tx']) ) {
        ...
        include "include/nd_rst_reservation_thanks.php";
    ...
    //START FIRST STEP SHORTCODE
        ...
        include "include/nd_rst_reservation_calendar.php";
...
function nd_rst_booking_php() {
    ...
    include "include/nd_rst_reservation_details.php";

    echo $nd_rst_booking_result;
...
function nd_rst_checkout_php() {
    ...
    include "include/nd_rst_reservation_confirm.php";


    echo $nd_rst_checkout_result;
