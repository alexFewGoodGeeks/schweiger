...
function nd_rst_add_calendar_view(){
    ...
    //query
    $nd_rst_orders = $wpdb->get_results( "SELECT * FROM $nd_rst_table_name WHERE nd_rst_date = '$nd_rst_date' AND nd_rst_order_status = '$nd_rst_order_status' AND nd_rst_restaurant = '$nd_rst_restaurant'");
