...
?>
    ...
    <style type="text/css">
    	...
    	/*color_dark_1*/
		.nd_rst_bg_dark_1 { background-color: <?php echo $nd_rst_customizer_color_dark_1;  ?>; }

		/*color_1*/
		.nd_rst_bg_color_1 { background-color: <?php echo $nd_rst_customizer_color_1;  ?>; }

		/*color_2*/
		.nd_rst_bg_color_2 { background-color: <?php echo $nd_rst_customizer_color_2;  ?>; }
